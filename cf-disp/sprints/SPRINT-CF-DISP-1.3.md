# CF-DISP-1.3 — Safeco / Liberty High-Intent Experience

## Purpose
Adds the Safeco/Liberty high-intent resource with factual HO-6 context, clear operator identity, and non-affiliation disclosure.
...
## Focused QA
Configuration: `qa/cf-disp/config/CF_DISP_1_3_QA.json`
Result: `qa/cf-disp/results/CF_DISP_1_3_QA_RESULT.json`
...
## Rollback
See `cf-disp/releases/CF_DISP_1_3_ROLLBACK.md`. Rollback is additive-first: remove/revert the sprint-owned integration while preserving the immutable v3.20.200 baseline semantics.
