# CF-DISP-4.0 — Definitive Safeco California Nonrenewal Guide

## Purpose
Turns the Safeco route into an informative source-governed guide rather than a thin lead-capture page.
...
## Focused QA
Configuration: `qa/cf-disp/config/CF_DISP_4_0_QA.json`
Result: `qa/cf-disp/results/CF_DISP_4_0_QA_RESULT.json`
...
## Rollback
See `cf-disp/releases/CF_DISP_4_0_ROLLBACK.md`. Rollback is additive-first: remove/revert the sprint-owned integration while preserving the immutable v3.20.200 baseline semantics.
