# CF-DISP-5.1 — Accessibility, Performance, Privacy + Security Certification

## Purpose
Certifies mobile-first source behavior, semantic controls, reduced motion, bounded/sanitized inputs, PII separation, and protected consent semantics.
...
## Focused QA
Configuration: `qa/cf-disp/config/CF_DISP_5_1_QA.json`
Result: `qa/cf-disp/results/CF_DISP_5_1_QA_RESULT.json`
...
## Rollback
See `cf-disp/releases/CF_DISP_5_1_ROLLBACK.md`. Rollback is additive-first: remove/revert the sprint-owned integration while preserving the immutable v3.20.200 baseline semantics.
