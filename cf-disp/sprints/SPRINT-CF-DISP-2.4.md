# CF-DISP-2.4 — Urgency-Aware Follow-Up + Deeper Continuation
...
## Focused QA
Configuration: `qa/cf-disp/config/CF_DISP_2_4_QA.json`
Result: `qa/cf-disp/results/CF_DISP_2_4_QA_RESULT.json`
...
## Rollback
See `cf-disp/releases/CF_DISP_2_4_ROLLBACK.md`. Rollback is additive-first: remove/revert the sprint-owned integration while preserving the immutable v3.20.200 baseline semantics.
